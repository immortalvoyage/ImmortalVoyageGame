const WILD_HERB_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" role="img" aria-labelledby="title desc">
  <title id="title">可用野草</title>
  <desc id="desc">一束以繩綁起的綠色野草。</desc>
...
const ITEM_HTTP_ASSETS = Object.freeze({
  '/assets/items/wild-herb.svg': Object.freeze({
    body: WILD_HERB_SVG,
    contentType: 'image/svg+xml; charset=UTF-8',
  }),
});

export function getItemHttpAsset(pathname) {
  return ITEM_HTTP_ASSETS[String(pathname || '')] ?? null;
}
