...
- PR #73 candidate: exact-source authoritative world-state invariant harness — 9/9 passed; legacy v1→v3 migration compatibility harness passed; `world-state.js` and new invariant test syntax checks passed.
